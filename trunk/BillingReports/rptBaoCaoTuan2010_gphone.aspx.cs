...
public partial class rptBaoCaoTuan2010_gphone : System.Web.UI.Page
{
    ...
    private void BindReport()
    {
        ...
        string strphanloaiCT = "select * from tblbctuan_gphone where type=1 and cast(tungay as datetime)='" +
        ...
        string strNam2010 = "select * from tblbctuan_gphone where type=2 and cast(tungay as datetime)='" +
            Convert.ToDateTime(Request.Params["NgayThang"].ToString(), vn).ToString("dd MMM yyyy") + "'  and cast(denngay as datetime)='" +
            Convert.ToDateTime(Request.Params["Toingay"].ToString()).ToString("dd MMM yyyy") + "'";  
        string strDoituong = "select * from tblbctuan_gphone where type=3 and cast(tungay as datetime)='" +
            Convert.ToDateTime(Request.Params["NgayThang"].ToString(), vn).ToString("dd MMM yyyy") + "'  and cast(denngay as datetime)='" +
            Convert.ToDateTime(Request.Params["Toingay"].ToString()).ToString("dd MMM yyyy") + "'"; 
        string strTinhTong = "select * from tblbctuan_gphone where type=0 and cast(tungay as datetime)='" +
            Convert.ToDateTime(Request.Params["NgayThang"].ToString(), vn).ToString("dd MMM yyyy") + "'  and cast(denngay as datetime)='" +
            Convert.ToDateTime(Request.Params["Toingay"].ToString()).ToString("dd MMM yyyy") + "'"; 
