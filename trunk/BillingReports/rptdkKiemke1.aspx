<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptdkKiemke1.aspx.cs" Inherits="rptdkKiemke1" %>
<%@ Register Assembly="DateTimePicker" Namespace="DateTimePicker" TagPrefix="cc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>BẢNG KIỂM KÊ NỢ PHẢI THU KHÁCH HÀNG SỬ DỤNG DỊCH VỤ VT- CNTT</title>
    <style type="text/css">
        .style1
        {
            height: 45px;
...
<body>
    ...
    <div>
        <table width="100%">
            ...
            <td>
                <asp:DropDownList ID="ddlType" runat="server" Width="200px">
                    ...
                    <asp:ListItem Value="1">Hành chính sự nghiệp</asp:ListItem>
                    <asp:ListItem Value="3">Doanh nghiệp</asp:ListItem>
                    <asp:ListItem Value="2">Doanh nghiệp viễn thông khác</asp:ListItem>
                    <asp:ListItem Value="4">Cá nhân, hộ gia đình</asp:ListItem>
             ...
             <tr>
            <td align="right" width="200px" class="style2">
                &nbsp;</td>
            <td class="style2">
                &nbsp;</td>        
            <td class="style2">
            ...
            <td class="style2">
             ...
             <tr>
            <td align="right" width="200px" class="style1">
                &nbsp;</td>
            <td class="style1">
                &nbsp;</td>        
            <td class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnTaoBaoCao" runat="server" Text="Xuất báo cáo" 
                    onclick="btnTaoBaoCao_Click"/>
             </td>        
            <td>
                &nbsp;</td>        
            <td>
