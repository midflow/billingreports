<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptdkBaoCaoTuan.aspx.cs"
    Inherits="rptdkBaoCaoTuan" %>
            ...
            <tr>
                ...
                <td align="right" width="100px">
                    <cc2:DaintyDate ID="ddIdentifyIssueDate" runat="server" FormatType="dd/MM/yyyy" 
                        SelectedDate="10/03/2009 16:28:00" />
                </td>
                ...
                <td>
                    <cc2:DaintyDate ID="ddIdentifyIssueToDate" runat="server" 
                        FormatType="dd/MM/yyyy" SelectedDate="10/09/2009 16:28:00" />
                </td>
            </tr>
            <tr>
                <td width="200px">
